...
- Runtime Fabric initialization should skip empty, whitespace-only, or placeholder API key values so local builds do not start Crashlytics with unresolved configuration.
- Testable Fabric API key validation should cover missing, blank, placeholder, and trimmed real values before Fabric starts.
