...
- Runtime Fabric initialization should skip empty, whitespace-only, or case-insensitive placeholder API key values so local builds do not start Crashlytics with unresolved configuration.
- Testable Fabric API key validation should cover missing, blank, case-insensitive placeholder, and trimmed real values before Fabric starts.
